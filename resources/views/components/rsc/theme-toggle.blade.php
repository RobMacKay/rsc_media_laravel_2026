...
<button type="button" x-data aria-label="{{ __('Switch theme') }}"
        ...
        class="cursor-pointer rounded-full border border-line px-3.5 py-[7px] font-mono text-[11px] text-muted transition-colors hover:border-brand hover:text-brand">
